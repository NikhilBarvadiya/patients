...
class _DateFilterState extends State<DateFilter> {
        ...
        children: [
          ...
          Obx(() {
            ...
            return Container(
              ...
              child: Text(
                'Active',
                style: GoogleFonts.poppins(fontSize: 11, fontWeight: FontWeight.w600, color: AppTheme.primaryBlue),
              ),
            );
          }),
        ],
          ...
          return GestureDetector(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: isSelected ? AppTheme.primaryBlue.withOpacity(0.3) : Colors.transparent, width: 1.5),
              ),
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(color: isSelected ? AppTheme.primaryBlue : Colors.grey.shade200, shape: BoxShape.circle),
                  ...
                  Expanded(
                    child: Text(
                      range,
                      style: GoogleFonts.poppins(fontSize: 13, fontWeight: FontWeight.w500, color: isSelected ? AppTheme.primaryBlue : Colors.grey.shade700),
                    ),
                  ),
                ],
              ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                spacing: 10.0,
                children: [
                  Icon(Icons.calendar_month_rounded, size: 16, color: date != null ? AppTheme.primaryBlue : Colors.grey.shade400),
                  Expanded(
                    child: Stack(
                      children: [
                        if (date == null)
                  ...
                  if (date != null) Icon(Icons.close, size: 16, color: AppTheme.primaryBlue),
                ],
              ),
            ),
          ),
  ...
  Widget _buildSelectedRangeCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [AppTheme.primaryBlue.withOpacity(0.05), AppTheme.primaryBlue.withOpacity(0.02)]),
        borderRadius: BorderRadius.circular(16),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(Icons.filter_alt_rounded, size: 22, color: AppTheme.primaryBlue),
          ),
          const SizedBox(width: 16),
          Expanded(
            child: Column(
          ...
          Expanded(
            child: TextButton(
              ...
              style: TextButton.styleFrom(
                backgroundColor: AppTheme.primaryBlue.withOpacity(.1),
