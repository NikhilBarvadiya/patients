...
import 'package:patients/views/auth/login/login_ctrl.dart';
                    ...
                    Center(
                      child: Column(
                        children: [
                          ...
                          Text('Sign in to continue your health journey', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: const Color(0xFF6B7280))),
                        ],
                      ),
                    ),
